...
namespace Dust7654_Launcher.Utility
{
    class UpdateManager
    {
        private const string UPDATE_ZIP_URL = "https://github.com/dust765/ClassicUO/releases/download/2.0.7/TazUOvsDust765-Beta-2.0.7-noconsole.zip";
        ...
        /// <summary>
        /// Download the most recent version of Dust7654
        /// </summary>
        ...
        public Task DownloadTUO(Action<int>? action = null, Action afterCompleted = null)
        {
            ...
            Task download = Task.Factory.StartNew(() =>
            {
                ...
                try
                {
                    Directory.CreateDirectory(LauncherSettings.Dust7654Path);

                    TrySetDirectoryFullPermissions(LauncherSettings.Dust7654Path);

                    ZipFile.ExtractToDirectory(tempFilePath, LauncherSettings.Dust7654Path, true);
                }
                catch (Exception ex)
                {
