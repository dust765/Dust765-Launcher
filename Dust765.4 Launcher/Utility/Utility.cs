...
namespace Dust7654_Launcher.Utility
{
    class Utility
    {
        ...
        public static bool FindDust7654()
        {
            string tuoPath = Path.Combine(LauncherSettings.LauncherPath, "Dust7654", "ClassicUO.exe");
        ...
        public static string GetDust7654UOExecutable()
        {
            string exePath = Path.Combine(LauncherSettings.LauncherPath, "Dust7654", "Dust765.exe");
            if (File.Exists(exePath))
                return exePath;

            return Path.Combine(LauncherSettings.LauncherPath, "Dust7654", "ClassicUO.exe");
        }
