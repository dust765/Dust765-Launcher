...
using Dust7654_Launcher.Utility;
using Dust7654_Launcher.Windows;

namespace Dust7654_Launcher
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            bool tuoInstalled = Utility.Utility.FindDust7654();
        ...
        {
            if (Utility.Utility.FindDust7654())
            {
                if (ProfileSelector.SelectedIndex > -1 && !UpdateManager.Instance.DownloadInProgress)
                {
                    string tuoExecutable = Utility.Utility.GetDust7654UOExecutable();
        ...
        {
            Version? l = UpdateManager.Instance.GetInstalledVersion(Utility.Utility.GetDust7654UOExecutable());
            if (l != null)
            {
